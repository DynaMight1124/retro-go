...
#ifdef ENGINE
	#define EXTERN
	#define EXTERN_ATTR EXT_RAM_BSS_ATTR
#else
...
EXTERN EXTERN_ATTR sectortype sector[MAXSECTORS];
EXTERN EXTERN_ATTR walltype wall[MAXWALLS];
EXTERN EXTERN_ATTR spritetype sprite[MAXSPRITES];

EXTERN uint16_t mapCRC;

EXTERN int32_t spritesortcnt;
EXTERN EXTERN_ATTR spritetype tsprite[MAXSPRITESONSCREEN];
...
EXTERN short nextspritesect[MAXSPRITES], nextspritestat[MAXSPRITES];
     ...
     */
EXTERN EXTERN_ATTR uint8_t  show2dsector[(MAXSECTORS+7)>>3];
EXTERN EXTERN_ATTR uint8_t  show2dwall[(MAXWALLS+7)>>3];
EXTERN EXTERN_ATTR uint8_t  show2dsprite[(MAXSPRITES+7)>>3];
...
EXTERN EXTERN_ATTR uint8_t  visitedSectors[(MAXSECTORS+7)>>3];
