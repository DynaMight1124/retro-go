...
UINT16 *ym_tl_tab = NULL;

/* ~3K wasted but oh well */
UINT16 *ym_tl_tab2 = NULL;
...
static INT32 *lfo_pm_table = NULL; /* 128 combinations of 7 bits meaningful (of F-NUMBER), 8 LFO depths, 32 LFO output levels per one depth */
...
static void init_tables(void)
{
	...
	if (lfo_pm_table == NULL)
		lfo_pm_table = rg_alloc(128 * 8 * 32 * sizeof(INT32), MEM_SLOW);
