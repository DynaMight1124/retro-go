...
u32 *HighCacheA = NULL; // caches for high layers
u32 *HighCacheB = NULL;
s32 *HighPreSpr = NULL; // slightly preprocessed sprites (2 banks a 128)
static int HighPreSprBank;

u32 *VdpSATCache_ptr = NULL;  // VDP sprite cache (1st 32 sprite attr bits)
...
unsigned char (*HighLnSpr)[32] = NULL;
