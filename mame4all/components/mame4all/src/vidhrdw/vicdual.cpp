...
void vicdual_vh_convert_color_prom(unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom)
{
	...
	{
		extern const struct GameDriver driver_heiankyo;
		extern const struct GameDriver driver_invinco;
		extern const struct GameDriver driver_digger;
		extern const struct GameDriver driver_tranqgun;
