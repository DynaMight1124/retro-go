...
static const struct MemoryReadAddress invaders_readmem[] =
{
...
static const struct MemoryWriteAddress invaders_writemem[] =
{
...
static const struct IOReadPort invaders_readport[] =
{
...
static const struct IOWritePort writeport_0_3[] =
{
...
static const struct IOWritePort writeport_1_2[] =
{
...
#if 0
static const struct IOWritePort writeport_2_3[] =
{
...
static const struct IOWritePort writeport_2_4[] =
{
	{ 0x02, 0x02, invaders_shift_amount_w },
...
static const struct IOWritePort writeport_4_3[] =
{
	{ 0x03, 0x03, invaders_shift_data_w },
...
static const struct MemoryReadAddress rollingc_readmem[] =
{
	{ 0x0000, 0x1fff, MRA_ROM },
	{ 0x2000, 0x3fff, MRA_RAM },
...
static const struct MemoryWriteAddress rollingc_writemem[] =
{
	{ 0x0000, 0x1fff, MWA_ROM },
	{ 0x2000, 0x23ff, MWA_RAM },
	{ 0x2400, 0x3fff, invaders_videoram_w, &videoram, &videoram_size },
...
#if 0
static const struct MemoryReadAddress sheriff_readmem[] =
{
...
static const struct MemoryWriteAddress sheriff_writemem[] =
{
...
static const struct IOReadPort sheriff_readport[] =
{
	{ 0x00, 0x00, input_port_0_r },
	{ 0x01, 0x01, input_port_1_r },
	{ 0x02, 0x02, input_port_2_r },
...
static const struct MemoryReadAddress sheriff_sound_readmem[] =
{
	{ 0x0000, 0x03ff, MRA_ROM },
	{ -1 }	/* end of table */
};
static const struct MemoryWriteAddress sheriff_sound_writemem[] =
{
	{ 0x0000, 0x03ff, MWA_ROM },
	{ -1 }	/* end of table */
};

static const struct IOReadPort sheriff_sound_readport[] =
{
...
static const struct IOWritePort sheriff_sound_writeport[] =
{
...
static const struct IOReadPort spcenctr_readport[] =
{
...
static const struct IOWritePort spcenctr_writeport[] =
{
	{ -1 }  /* end of table */
};
...
static const struct IOReadPort gunfight_readport[] =
{
	{ 0x00, 0x00, input_port_0_r },
	{ 0x01, 0x01, input_port_1_r },
	{ 0x02, 0x02, input_port_2_r },
...
static const struct MemoryReadAddress schaser_readmem[] =
{
	{ 0x0000, 0x1fff, MRA_ROM },
	{ 0x2000, 0x3fff, MRA_RAM },
	{ 0x4000, 0x5fff, MRA_ROM },
...
static const struct MemoryWriteAddress schaser_writemem[] =
{
	{ 0x0000, 0x1fff, MWA_ROM },
	{ 0x2000, 0x23ff, MWA_RAM },
	{ 0x2400, 0x3fff, invaders_videoram_w, &videoram, &videoram_size },
...
#if 0
static const struct MemoryReadAddress helifire_readmem[] =
{
	{ 0x0000, 0x27ff, MRA_ROM },
	{ 0x4200, 0x7fff, MRA_RAM },
...
static const struct MemoryWriteAddress helifire_writemem[] =
{
	{ 0x0000, 0x27ff, MWA_ROM },
	{ 0x4200, 0x5dff, invaders_videoram_w, &videoram, &videoram_size },
	{ 0x5e00, 0x7fff, MWA_RAM },
...
static const struct IOReadPort bowler_readport[] =
{
...
static const struct IOReadPort shuffle_readport[] =
{
...
static const struct IOReadPort seawolf_readport[] =
{
...
static const struct IOReadPort checkmat_readport[] =
{
	{ 0x00, 0x00, input_port_0_r },
	{ 0x01, 0x01, input_port_1_r },
	{ 0x02, 0x02, input_port_2_r },
...
static const struct IOWritePort checkmat_writeport[] =
{
	{ -1 }  /* end of table */
};
