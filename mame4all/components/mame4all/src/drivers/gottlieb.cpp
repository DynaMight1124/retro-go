...
static const struct MemoryReadAddress reactor_readmem[] =
{
...
static const struct MemoryWriteAddress reactor_writemem[] =
{
...
static const struct MemoryReadAddress gottlieb_readmem[] =
{
...
static const struct MemoryWriteAddress gottlieb_writemem[] =
{
...
static const struct MemoryWriteAddress usvsthem_writemem[] =
{
	{ 0x00000, 0x00fff, MWA_RAM, &nvram, &nvram_size },
	{ 0x01000, 0x01fff, MWA_RAM },	/* ROM in Krull */
	{ 0x02000, 0x02fff, MWA_RAM },	/* ROM in Krull and 3 Stooges */
...
static const struct MemoryReadAddress stooges_readmem[] =
{
	{ 0x00000, 0x00fff, MRA_RAM },
...
static const struct MemoryWriteAddress stooges_writemem[] =
{
	{ 0x00000, 0x00fff, MWA_RAM, &nvram, &nvram_size },
...
static const struct MemoryReadAddress stooges_sound_readmem[] =
{
...
static const struct MemoryReadAddress stooges_sound2_readmem[] =
{
	{ 0x0000, 0x03ff, MRA_RAM },
...
static const struct GfxLayout charRAMlayout =
{
	8,8,    /* 8*8 characters */
	128,    /* 128 characters */
	4,      /* 4 bits per pixel */
...
static const struct GfxLayout charROMlayout =
{
	8,8,    /* 8*8 characters */
	256,    /* 256 characters */
	4,      /* 4 bits per pixel */
...
static const struct GfxLayout qbertqub_spritelayout =
{
	16,16,  /* 16*16 sprites */
	512,    /* 512 sprites */
	4,      /* 4 bits per pixel */
...
static const struct GfxDecodeInfo charRAM_gfxdecodeinfo[] =
{
...
static const struct GfxDecodeInfo charROM_gfxdecodeinfo[] =
{
...
static const struct GfxDecodeInfo qbertqub_gfxdecodeinfo[] =
{
	{ REGION_GFX1, 0x0000, &charROMlayout,         0, 1 },
...
static const struct DACinterface dac1_interface =
{
	1,
	{ 50 }
};

static const struct DACinterface dac2_interface =
{
	2,
	{ 25, 25 }
};
