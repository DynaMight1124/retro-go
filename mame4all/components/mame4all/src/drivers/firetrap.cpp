...
static const struct MemoryReadAddress readmem_bootleg[] =
{
	{ 0x0000, 0x7fff, MRA_ROM },
	{ 0x8000, 0xbfff, MRA_BANK1 },
	{ 0xc000, 0xe97f, MRA_RAM },
...
static const struct MemoryWriteAddress writemem_bootleg[] =
{
	{ 0x0000, 0xbfff, MWA_ROM },
	{ 0xc000, 0xcfff, MWA_RAM },
	{ 0xd000, 0xd7ff, firetrap_bg1videoram_w, &firetrap_bg1videoram, &firetrap_bgvideoram_size },
...
static const struct MachineDriver machine_driver_firetpbl =
{
	/* basic machine hardware */
	{
		{
