...
static const struct MemoryReadAddress firetrk_readmem[] =
{
...
static const struct MemoryWriteAddress firetrk_writemem[] =
{
...
static const struct MemoryReadAddress superbug_readmem[] =
{
	{ 0x0000, 0x00ff, MRA_RAM },
...
static const struct MemoryWriteAddress superbug_writemem[] =
{
...
static const struct MemoryReadAddress montecar_readmem[] =
{
	{ 0x0000, 0x00ff, MRA_RAM },
	{ 0x0100, 0x07ff, firetrk_zeropage_r },
	{ 0x0800, 0x08ff, MRA_RAM },
...
static const struct MemoryWriteAddress montecar_writemem[] =
{
	{ 0x0000, 0x00ff, MWA_RAM, &firetrk_alpha_num_ram },
...
static const struct GfxLayout firetrk_text_layout =
{
	16, 16, /* width, height */
	32,     /* total         */
	1,      /* planes        */
...
static const struct GfxLayout superbug_text_layout =
{
	16, 16, /* width, height */
	32,     /* total         */
	1,      /* planes        */
...
static const struct GfxLayout montecar_text_layout =
{
	8, 8,   /* width, height */
	64,     /* total         */
	1,      /* planes        */
...
static const struct GfxLayout firetrk_tile_layout =
{
	16, 16, /* width, height */
	64,     /* total         */
	1,      /* planes        */
...
static const struct GfxLayout superbug_tile_layout =
{
	16, 16, /* width, height */
	64,     /* total         */
	1,      /* planes        */
...
static const struct GfxLayout firetrk_car_layout1 =
{
	32, 32, /* width, height */
	4,      /* total         */
	1,      /* planes        */
...
static const struct GfxLayout superbug_car_layout1 =
{
	32, 32, /* width, height */
	4,      /* total         */
	1,      /* planes        */
...
static const struct GfxLayout montecar_car_layout =
{
	32, 32, /* width, height */
	8,      /* total         */
	2,      /* planes        */
...
static const struct GfxLayout firetrk_car_layout2 =
{
	32, 32, /* width, height */
	4,      /* total         */
	1,      /* planes        */
...
static const struct GfxLayout superbug_car_layout2 =
{
	32, 32, /* width, height */
	4,      /* total         */
	1,      /* planes        */
...
static const struct GfxLayout firetrk_trailer_layout =
{
	64, 64, /* width, height */
	8,      /* total         */
	1,      /* planes        */
...
static const struct GfxDecodeInfo firetrk_gfxdecodeinfo[] =
{
...
static const struct GfxDecodeInfo superbug_gfxdecodeinfo[] =
{
...
static const struct GfxDecodeInfo montecar_gfxdecodeinfo[] =
{
