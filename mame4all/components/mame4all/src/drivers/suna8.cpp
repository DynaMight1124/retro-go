...
static const struct MemoryReadAddress hardhead_readmem[] =
{
...
static const struct MemoryWriteAddress hardhead_writemem[] =
{
...
static const struct IOReadPort hardhead_readport[] =
{
	{ 0x00, 0x00, IORP_NOP	},	// ? IRQ Ack
	{-1}
};

static const struct IOWritePort hardhead_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress rranger_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM				},	// ROM
	{ 0x8000, 0xbfff, MRA_BANK1				},	// Banked ROM
...
static const struct MemoryWriteAddress rranger_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM				},	// ROM
	{ 0x8000, 0xbfff, MWA_ROM				},	// Banked ROM
...
static const struct IOReadPort rranger_readport[] =
{
	{ 0x00, 0x00, IORP_NOP	},	// ? IRQ Ack
	{-1}
};

static const struct IOWritePort rranger_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress brickzn_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM					},	// ROM
	{ 0x8000, 0xbfff, MRA_BANK1					},	// Banked ROM
...
static const struct MemoryWriteAddress brickzn_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM						},	// ROM
	{ 0x8000, 0xbfff, MWA_ROM						},	// Banked ROM
...
static const struct IOReadPort brickzn_readport[] =
{
	{-1}
};

static const struct IOWritePort brickzn_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress hardhea2_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM					},	// ROM
	{ 0x8000, 0xbfff, MRA_BANK1					},	// Banked ROM
...
static const struct MemoryWriteAddress hardhea2_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM					},	// ROM
	{ 0x8000, 0xbfff, MWA_ROM					},	// Banked ROM
...
static const struct IOReadPort hardhea2_readport[] =
{
	{-1}
};

static const struct IOWritePort hardhea2_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress starfigh_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM					},	// ROM
	{ 0x8000, 0xbfff, MRA_BANK1					},	// Banked ROM
	{ 0xc000, 0xc000, input_port_0_r			},	// P1 (Inputs)
...
static const struct MemoryWriteAddress starfigh_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM						},	// ROM
	{ 0x8000, 0xbfff, MWA_ROM						},	// Banked ROM
...
static const struct IOReadPort starfigh_readport[] =
{
	{-1}
};

static const struct IOWritePort starfigh_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress hardhead_sound_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM					},	// ROM
...
static const struct MemoryWriteAddress hardhead_sound_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM					},	// ROM
...
static const struct IOReadPort hardhead_sound_readport[] =
{
	{ 0x01, 0x01, IORP_NOP	},	// ? IRQ Ack
	{-1}
};

static const struct IOWritePort hardhead_sound_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress rranger_sound_readmem[] =
{
	{ 0x0000, 0x7fff, MRA_ROM					},	// ROM
	{ 0xc000, 0xc7ff, MRA_RAM					},	// RAM
	{ 0xd800, 0xd800, soundlatch_r				},	// From Main CPU
...
static const struct MemoryWriteAddress rranger_sound_writemem[] =
{
	{ 0x0000, 0x7fff, MWA_ROM					},	// ROM
	{ 0xc000, 0xc7ff, MWA_RAM					},	// RAM
	{ 0xd000, 0xd000, soundlatch2_w				},	//
...
static const struct IOReadPort rranger_sound_readport[] =
{
	{-1}
};

static const struct IOWritePort rranger_sound_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress brickzn_sound_readmem[] =
{
...
static const struct MemoryWriteAddress brickzn_sound_writemem[] =
{
...
static const struct IOReadPort brickzn_sound_readport[] =
{
	{-1}
};

static const struct IOWritePort brickzn_sound_writeport[] =
{
	{-1}
};
...
static const struct MemoryReadAddress brickzn_pcm_readmem[] =
{
	{ 0x0000, 0xffff, MRA_ROM	},	// ROM
	{-1}
};

static const struct MemoryWriteAddress brickzn_pcm_writemem[] =
{
...
static const struct IOReadPort brickzn_pcm_readport[] =
{
	{ 0x00, 0x00, soundlatch2_r		},	// From Sound CPU
	{-1}
};

static const struct IOWritePort brickzn_pcm_writeport[] =
{
...
static const struct GfxLayout layout_8x8x4 =
{
	8,8,
	RGN_FRAC(1,2),
	4,
...
static const struct GfxDecodeInfo suna8_gfxdecodeinfo[] =
{
...
static const struct YM3812interface hardhead_ym3812_interface =
{
	1,
	4000000,	/* ? */
	{ 50 },
...
/* 2203 + 8910 */
static const struct YM2203interface rranger_ym2203_interface =
{
	2,
	4000000,	/* ? */
...
static const struct AY8910interface brickzn_ay8910_interface =
{
	1,
	4000000,	/* ? */
	{ 33 },
...
static const struct DACinterface brickzn_dac_interface =
{
	4,
...
static const struct YM3812interface starfigh_ym3812_interface =
{
	1,
	4000000,	/* ? */
	{ 50 },
