...
static int share[0x800];

static READ_HANDLER( robocop_68000_share_r )
{
	return share[offset/2];
}

static WRITE_HANDLER( robocop_68000_share_w )
{
...
{
	install_mem_read_handler(0, 0x180000, 0x180fff, robocop_68000_share_r);
	install_mem_write_handler(0, 0x180000, 0x180fff, robocop_68000_share_w);
}
