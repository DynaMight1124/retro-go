...
#define PSXBIOS_LOG(...) do { } while (0)
#endif
#ifndef PSXBIOS_EV_LOG
//#define PSXBIOS_EV_LOG printf
#define PSXBIOS_EV_LOG(...) do { } while (0)
#endif
...
static FileDesc FDesc[32] CORE_BSS_ATTR;
static char ffile[64] CORE_BSS_ATTR;
static int nfile CORE_BSS_ATTR;
static char cdir[8*8+8] CORE_BSS_ATTR;
static u32 floodchk CORE_BSS_ATTR;
