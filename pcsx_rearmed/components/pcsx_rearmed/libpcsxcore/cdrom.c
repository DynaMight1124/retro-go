...
#else
#define CDR_LOG(...) do { } while (0)
#endif
#if 0
#define CDR_LOG_I SysPrintf
#else
#define CDR_LOG_I(fmt, ...) \
	do { log_unhandled("%u cdrom: " fmt, psxRegs.cycle, ##__VA_ARGS__); } while (0)
#endif
#if 0
#define CDR_LOG_IO SysPrintf
#else
#define CDR_LOG_IO(...) do { } while (0)
#endif
//#define CDR_LOG_CMD
