...
/* YUV stuff */
static EXT_RAM_BSS_ATTR int yuv_ry[32], yuv_gy[32], yuv_by[32];
static EXT_RAM_BSS_ATTR unsigned char yuv_u[32 * 2], yuv_v[32 * 2];
static EXT_RAM_BSS_ATTR struct uyvy { uint32_t y:8; uint32_t vyu:24; } yuv_uyvy[32768];
